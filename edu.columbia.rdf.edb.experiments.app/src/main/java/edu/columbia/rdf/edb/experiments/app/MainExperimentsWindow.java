...
import edu.columbia.rdf.edb.experiments.app.search.SimpleSearchPanel;
...
public class MainExperimentsWindow extends ModernRibbonWindow
  ...
  /** The m search panel. */
  private SimpleSearchPanel mSearchPanel;
  ...
  /** The m files button. */
  private ModernButton mFilesButton;
  ...
  private ModernButton mAddToCartButton;
  ...
  public final void createRibbon() {
    ...
    getRibbonMenu().addTabbedMenuItem(Application.MENU_SAVE_SEARCH);

    getRibbonMenu().addTabbedMenuItem(Application.MENU_LOAD_SEARCH);
    ...
    ModernButton button = getRibbon().getHomeToolbar().getSection("Samples").createButton("Info",
    ...
    mAddToCartButton = getRibbon().getHomeToolbar().getSection("Cart").createButton("Add To Cart", 
  ...
  public final void createUi() {
    ...
    mSearchPanel = new SimpleSearchPanel(this); //SearchPanel(this);
