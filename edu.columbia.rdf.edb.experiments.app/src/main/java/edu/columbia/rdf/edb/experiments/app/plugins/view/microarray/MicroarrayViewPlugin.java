...
public class MicroarrayViewPlugin extends ViewPlugin implements ModernClickListener {
	...
	public void initSampleSorters(SortModel<Sample> sampleSortModel) {
		sampleSortModel.add(new SortSamplesByArrayPlatform());
	...
	/* (non-Javadoc)
	 * @see edu.columbia.rdf.edb.ui.ViewPlugin#initSampleFolders(org.abh.common.ui.search.SortModel)
	 */
	@Override
	public void initSampleFolders(SortModel<Sample> views) {
		views.add(new ViewSamplesByArrayPlatform());
	}
	...
	public void initSearchCategories(SearchCategoryService searchCategoryService) {
		...
		/*
		group = new SearchCategoryGroup("Source Section");
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/material_type"), "Source Material Type"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_organism"), "Organism", "Search by organism, e.g. Homo sapiens."));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_organism_part"), "Organism Part"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_disease_state"), "Disease State"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_cell_type"), "Cell Type"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_treatment"), "Treatment"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_time_point"), "Time Point", "Search by when sample was treated, e.g. 8h."));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_tumor_cells"), "% Tumor Cells"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_disease_status"), "Disease Status"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_gender"), "Gender", "Search by gender, e.g. male, female, or unknown."));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_age"), "Age", "Search by patient age, e.g. 3 yr."));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_clinical_parameters"), "Clinical Parameters"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_cytogenetics"), "Cytogenetics"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_igv_status"), "IgV Status"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_gep_based_classification"), "GEP based classification"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_biosourceprovider"), "BioSourceProvider"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/source/characteristics_source_protocol"), "Source Protocol"));
		searchCategoryService.addGroup(group);

		group = new SearchCategoryGroup("Sample Section");
		group.addCategory(new SearchCategory(new StrictPath("/microarray/sample/material_type"), "Sample Material Type"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/sample/characteristics_sample_protocol"), "Sample Protocol"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/sample/characteristics_sample_operator"), "Sample Operator"));
		searchCategoryService.addGroup(group);

		group = new SearchCategoryGroup("Extract Section");
		group.addCategory(new SearchCategory(new StrictPath("/microarray/extract/material_type"), "Extract Material Type"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/extract/characteristics_extract_protocol"), "Extract Protocol"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/extract/characteristics_extract_operator"), "Extract Operator"));
		searchCategoryService.addGroup(group);

		group = new SearchCategoryGroup("Labeled Extract Section");
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/label"), "Label"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_labeled_extract_protocol"), "Labeled Extract Protocol"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_labeled_extract_operator"), "Labeled Extract Operator"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/material_type"), "Labeled Extract Material Type"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_array_platform"), "Array Platform", "Search by array platform, e.g. HG-U133_Plus_2."));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_hybridization_protocol"), "Hybridization Protocol"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_scanning_protocol"), "Scanning Protocol"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_chp_normalization_method"), "CHP Normalization Method"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_hybridization_facility"), "Hybridization Facility"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_mas5_normalization"), "MAS5 Normalization"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_mas5_normalization_file"), "MAS5 Normalization File"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_rma_normalization"), "RMA Normalization"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_rma_normalization_file"), "RMA Normalization File"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_geo_series_accession"), "GEO Series Accession", "Search by GEO series accession e.g. GSE2350."));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_geo_accession"), "GEO Accession", "Search by GEO accession e.g. GSM44066."));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/labeled_extract/characteristics_geo_platform"), "GEO Platform", "Search by GEO platform, e.g. GPL8300."));
		searchCategoryService.addGroup(group);

		group = new SearchCategoryGroup("Hybridization Section");
		group.addCategory(new SearchCategory(new StrictPath("/microarray/hybridization/array_data_file"), "Array Data File"));
		group.addCategory(new SearchCategory(new StrictPath("/microarray/hybridization/derived_array_data_file"), "Derived Array Data File"));
		*/
		...
		group.addCategory(new SearchCategory("% Tumor Cells", 
				new Path("/Microarray/Sample/Source/Characteristic/Percent_Tumor_Cells")));
		...
		group.addCategory(new SearchCategory("Extract Protocol", 
				new Path("/Microarray/Sample/Extract/Characteristic/Extract_Protocol")));
		group.addCategory(new SearchCategory("Extract Operator", 
				new Path("/Microarray/Sample/Extract/Characteristic/Extract_Operator")));
		searchCategoryService.addGroup(group);
		...
		group.addCategory(new SearchCategory("GEO Platform", 
				new Path("/Microarray/Sample/Labeled_Extract/Characteristic/GEO_Platform")));
		searchCategoryService.addGroup(group);
	...
	public void customizeSampleMenu(ModernPopupMenu menu) {
		menu.add(new ModernTitleIconMenuItem("Microarray"));
