...
public class SamplesTreePanel extends SamplesPanel implements ModernClickListener {
	...
	private ViewModel mViewModel = 
			new ViewModel(SettingsService.getInstance().getAsString("edb.experiments.samples.default-view"));
	...
	private class FilterEvents implements FilterEventListener {
		...
		/* (non-Javadoc)
		 * @see org.abh.common.ui.search.FilterEventListener#filterChanged(org.abh.common.event.ChangeEvent)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see org.abh.common.ui.search.FilterEventListener#filtersUpdated(org.abh.common.event.ChangeEvent)
		 */
		@Override
	...
	private void createMenu() {
		...
		for (SampleSorter sorter : sortModel) {
		...
		for (String name : names) {
			ModernCheckBoxMenuItem item = new ModernCheckBoxMenuItem(name);
	...
	/* (non-Javadoc)
	 * @see edu.columbia.rdf.edb.experiments.app.sample.SamplesPanel#addSelectionListener(org.abh.common.ui.event.ModernSelectionListener)
	 */
	...
	*/
	...
	/* (non-Javadoc)
	 * @see edu.columbia.rdf.edb.experiments.app.sample.SamplesPanel#getSelectedSamples()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.columbia.rdf.edb.experiments.app.sample.SamplesPanel#setSelectedSample(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.columbia.rdf.edb.experiments.app.sample.SamplesPanel#setSelectedSample(int)
	 */
