...
public class RibbonShowSection extends RibbonSection implements ModernClickListener {
	...
	public RibbonShowSection(Ribbon ribbon, ModernToolTipModel tooltipModel) {
		...
		//Ui.setSize(experimentsButton, ModernTheme.getInstance().getClass("ribbon-large-button").getDimension("extra-wide"));
		...
		categoriesButton.setToolTip(new ModernToolTip("Show Categories Pane", "Display the category directory."), tooltipModel);
		categoriesButton.setClickMessage("categories_pane");
		//Ui.setSize(categoriesButton, ModernTheme.getInstance().getClass("ribbon-large-button").getDimension("extra-wide"));
		...
		//Ui.setSize(summaryButton, ModernTheme.getInstance().getClass("ribbon-large-button").getDimension("wide"));
