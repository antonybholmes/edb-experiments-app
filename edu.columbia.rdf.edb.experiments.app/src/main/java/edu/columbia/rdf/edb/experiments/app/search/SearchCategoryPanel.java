...
public class SearchCategoryPanel extends HBox implements KeyListener, ModernClickListener, ModernClickEventProducer {
	...
	private static final Dimension CRITERIA_SIZE = 
	 ...
	 */
	public SearchCategoryPanel(ModernWindow parent, 
			int index,
			SearchStackOperator booleanOperator,
			String text,
	    ...
	    //mSearchText.setPreferredSize(new Dimension(Short.MAX_VALUE, ModernWidget.WIDGET_HEIGHT));
	    //mSearchText.setMaximumSize(new Dimension(Short.MAX_VALUE, ModernWidget.WIDGET_HEIGHT));
		...
		mField = new SearchCategoryDropDownMenuButton(field, 
				searchCriteriaPopup);
