...
public class SearchFolderTree extends ModernTree<UserSearch> implements XmlRepresentation {
	...
	private static Path USER_FILE = 
			PathUtils.getPath("user.search.folders.xml");
	
	/** The default file. */
	private static Path DEFAULT_FILE = 
			PathUtils.getPath("res/default.search.folders.xml");
	...
	public class TreeEvents implements TreeEventListener {
		...
		/* (non-Javadoc)
		 * @see org.abh.common.ui.tree.TreeEventListener#treeNodeDragged(org.abh.common.ui.tree.ModernTreeEvent)
		 */
		@Override
		public void treeNodeDragged(ModernTreeEvent e) {
			//System.err.println("drag " + getSelectedNodes().get(0).getName() + " " + getTargetNode().getName());
		...
		/* (non-Javadoc)
		 * @see org.abh.common.ui.tree.TreeEventListener#treeNodeClicked(org.abh.common.ui.tree.ModernTreeEvent)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see org.abh.common.ui.tree.TreeEventListener#treeNodeDoubleClicked(org.abh.common.ui.tree.ModernTreeEvent)
		 */
		@Override
	...
	public void addSearchFolder(String name, UserSearch userSearch) {
		TreeNode<UserSearch> child = 
				new SearchFolderTreeNode(name, userSearch);
	...
	/**
	 * Checks for the existance of the default search file and then creates
	 * one if necessary.
	 *
	 ...
	 * @throws ParserConfigurationException the parser configuration exception
	 */
	public static ModernTree<UserSearch> loadXml(Path file) throws SAXException, IOException, ParserConfigurationException {
	 ...
	 * @throws ParserConfigurationException the parser configuration exception
	 */
	private synchronized static ModernTree<UserSearch> loadXml(InputStream is) throws SAXException, IOException, ParserConfigurationException {
		if (is == null) {
			return null;
		}
